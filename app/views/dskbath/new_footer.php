    ...
    <!-- Section: Links -->
      ...
      <div class="row justify-content-start ">
        <!--Grid column-->
         <div class="col-lg-4 col-md-12 col-sm-12 pb-5" style="background-color:rgba(238,238,238,255)">
           <div class="footerlogo pb-3">
            ...
            <p
             style="" class="text-muted">DSK has wide range of bathroom products which are of High Standards, each of which has
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 pb-2"  style="background-color:rgba(238,238,238,255);">
          ...
          <p class="text-muted" style="color:black;">DSK Bath Solutions, GIDC Phase 3, Dared, Jamnagar, Gujrat-361004.</p>
          <p class="text-muted" style="color:black;">Phone: 07021632636</p>
           <div class="social">
              <h1>Follow us</h1>
              <div class="Social-media">
                <a href="#"><font color="#0dcaf0"><i class="fab fa-facebook"></i></font></a>
                <a href="#"><font color="#0dcaf0"><i class="fab fa-linkedin"></i></font></a>
                <a href="#"><font color="#0dcaf0"><i class="fab fa-instagram"></i></font></a>
                <a href="#"><font color="#0dcaf0"><i class="fab fa-youtube"></i></a></font>
              </div>
          </div>
        </div>
